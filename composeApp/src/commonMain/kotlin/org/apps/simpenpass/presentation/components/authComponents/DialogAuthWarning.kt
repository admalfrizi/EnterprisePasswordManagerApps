...
import resources.email_warning_ic
import resources.pass_warning_ic

@Composable
fun DialogAuthWarning(
        ...
        Card(
            ...
            Column(
                ...
                Row(
                    ...
                    Image(
                        painterResource(Res.drawable.email_warning_ic),
                        contentDescription = ""
                    )
                    Spacer(
                    ...
                    Image(
                        painterResource(Res.drawable.pass_warning_ic),
                        contentDescription = ""
                    )
                }
                Spacer(
